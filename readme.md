...
Persons and Currie (2014) also fail to account for the potential influence of body mass on fourth trochanter position. Animals of greater body mass necessarily require more force per unit time to move than their smaller relatives; thus, it stands to reason that larger dinosaurs would increase the mechanical advantage of their muscles, since it would allow them to output more force for less energy expenditure. The ornithischian taxon examined by Persons and Currie (2014) belonged to a very large genus (*Lambeosaurus*), which was likely heavier than both of the tyrannosaurid species examined in the same study. Thus, the conclusion of their paper is potentially a chance result due to differences in scale, not different evolutionary strategies. In summary, the conclusions reached by Persons and Currie (2014) are weakened by their failure to track the phylogenetic history of the characteristic ornithischian fourth trochanter, their lack of a rigorous statistical comparison between ornithischians and other dinosaurs, and their consideration of only very large taxa. 
...
Figure 7A shows the contour map obtained from ancestral state reconstruction of trochanter position using our time-calibrated composite Dinosauria phylogeny. As the color becomes warmer (moves from blue to red), the position of the fourth trochanter moves more distally from the head of the femur. 

As can be seen on the contour map, the fourth trochanter was primitively positioned very proximally along the femur. The branch leading up to the outgroup Marasuchus and to Dinosauria plot a very proximal fourth trochanter position. Certain basal Dinosaurs, *Eoraptor* and *Staurikosaurus*, retain this proximal position, and may even have slightly more proximal positions.
The contour map also illustrates that a major shift in fourth trochanter position occurred during the evolution of Ornithischia, before the first included ornithischian taxon (*Heterodontosaurus*) diverged from the rest of the clade. This places the acquisition of the trait in the late Triassic. After the acquisition of distal fourth trochanters, no ornithischians revert to the primitive condition, although the feature does occasionally become more exaggerated.

![GitHub Logo](Figure_7A_nodelabels.png)

**Figure 7A.** Contour map of time-calibrated composite Dinosauria phylogeny  for fourth trochanter position. More distal placement of the fourth trochanter is represented by warmer colors.

The saurischian taxa display a much more variable pattern in fourth trochanter position, with multiple independent episodes of proximal and distal movement. Some saurischian taxa (*Ceratosaurus*, *Sinosaurus*, *Streptospondylus*, and *Yangchuanosaurus*) converge on placements similar to those of ornithischians, but the majority of examined species show fourth trochanter positions close to the proximal condition primitive for Dinosauria. The initial pattern within the saurischians seems to have been an initial stasis at the primitive position of the fourth trochanter, followed by a distal movement initiating in the branch separating *Dilophosaurus* from *Liliensternus*. This continues until the branch leading to the MRCA of *Piatnitzkysaurus* and *Tyrannosaurus* (coinciding, interestingly, with the base of the clade Orionides), after which the fourth trochanter moves proximally. Two isolated events of distal movement can be seen within the Orionides, one in the branch leading up to *Streptospondylus* and *Suchomimus*, and one in the branch leading up to *Yangchuanosaurus*. Another significant proximal movement of the fourth trochanter occurs at the branch leading up to the MRCA of *Sinosauropteryx* and *Tyrannosaurus*. Within the tyrannosaurs, an initial distal movement of the fourth trochanter is seen, after which its placement is more variable; *Albertosaurus* and *Gorgosaurus* (and to a lesser degree *Tyrannosaurus* itself) show slight trends to more distal fourth trochanters, while their closest relatives do not. Two events of extreme proximal movement of the fourth trochanter occur; one in the branch leading to *Piatnitzkysaurus*, and one in the branch leading  to *Compsognathus* and *Sinosauropteryx*. 

A significant distally-directed movement of the fourth trochanter is seen in the ornithischians in the branch leading up to *Camptosaurus* and more derived ornithopods, which together comprise the clade Ankylopollexia. Within Ankylopollexia, the fourth trochanter position attains a very distal position within *Camptosaurus*, and begins to move back proximally along the femur along the stem of Hadrosauroidea. It then moves distally once again in *Saurolophus angustirostris* and *Corythosaurus intermedius*. The general pattern within the ornithischians seems to be an overall distal movement of the fourth trochanter with more derived taxa, with a significantly distal placement in basal members of Ankylopollexia and a few derived taxa.

Figure 7B shows the contour map obtained for the time-calibrated Dinosauria phylogeny from ancestral state reconstruction of body mass. Increasing body mass is represented by warmer colors. The range of body mass seen ranges from no more than a few kilograms to nearly 13000 kilograms among the Ornithischians, and from no more than a few kilograms to nearly 7500 kilograms among the Saurischians. As a result, the contour map was created using the log of body mass, so that finer changes in body mass are more clearly visible. 

![GitHub Logo](Figure_7B_nodelabels.png)

**Figure 7B.** Contour Map of time-calibrated composite Dinosauria phylogeny for body mass. Larger body mass is represented by warmer colors.

The primitive condition for Dinosauria was one of relatively small body mass, as can be seen from the coloring of the branch leading up to Dinosauria. There seems to have actually been a decrease in body mass leading up to the clade of Ornithischia, following which an increase is seen in all derived branches save for the branch leading up to *Psittacosaurus* and certain taxa within the clade of Ankylopollexia. Comparing 7A with 7B it can be seen that the branch leading up to the ornithischians experienced a significant decrease in body mass but a significant distal movement of the fourth trochanter position; indeed, very small (under 10 kg) basal ornithischian taxa possessed distally-positioned fourth trochanters. Increasing body mass was therefore not the initial driver of the fourth trochanter’s distal movement.   

As described earlier, only a handful of saurischian taxa reach fourth trochanter positions as distal as those seen in ornithischians. This is illustrated by Figure 8, where the two clades can be seen to have little overlap. 
...
The results of interest from our phylogenetic signal testing were the values obtained for K and p. The value K indicates whether related taxa within the tree under concern resemble each other more or less than would be expected under a random walk through morphospace. A K value greater than 1 indicates a greater than expected resemblance between related species, whereas a K value less than 1 indicates a less than expected resemblance between related species. We considered p values of less than 0.05 to indicate statistical significance, as is standard in most existing studies.
...
The results obtained from these analyses are found in Table 1. Of our six total analyses, three yielded significant results. Examining the whole of Dinosauria showed that fourth trochanter position showed a significant phylogenetic signal, with K greater than 1, indicating that related species resembled each other more than would be expected by chance. Body mass showed the opposite; related species resembled each other less than would be expected by chance. When examining these results in the context of the sub-trees, Saurischian body mass showed a K significantly less than 1. No other combination of characters and phylogenies showed a significant result; this may be an artefact of the smaller sample size and lower disparity within each subtree, or reflect a real biological pattern.
...
5. David B. Weishampel, Peter Dodson, and Halszka Osmolska. “The Dinosauria”, 2nd ed. University of California Press, 2007.

6. Gregory S. Paul. “The Princeton Field Guide to Dinosaurs”. Princeton University Press, 2010.

7. He et al. "A New Leptoceratopsid (Ornithischia, Ceratopsia) with a Unique Ischium from the Upper Cretaceous of Shandong Province, China". *PLoS ONE* 10:12 (2015). DOI: http://dx.doi.org/10.1371/journal.pone.0144148.

8. Hutchinson et al. "A Computational Analysis of Limb and Body Dimensions in *Tyrannosaurus rex* with Implications for Locomotion, Ontogeny, and Growth". *PLoS ONE* (2011). DOI: http://dx.doi.org/10.1371/journal.pone.0026037.

9. John R. Hutchinson and Mariano Garcia. "Tyrannosaurus was not a fast runner". *Nature* 415: 1018-1021 (2001). DOI: http://dx.doi.org/10.1038/4151018a.

10. Jostein Starrfelt and Lee Hsiang Liow. “How many dinosaur species were there? Fossil bias and true richness estimated using a Poisson sampling model”. *Philosophical Transactions of the Royal Society B* 371:1691 (2016). DOI: http://dx.doi.org/10.1098/rstb.2015.0219.

11. Kenneth Carpenter and Yvonne Wilson. “A New Species of Camptosaurs (Ornithopoda: Dinosauria) from the Morrison Formation (Upper Jurassic) of Dinosaur National Monument, Utah, and  Biomechanics Analysis of its Forelimb”. *Annals of Carnegie Museum* 76 (2008): 227-263. DOI: http://dx.doi.org/10.2992/0097-4463(2008)76[227:ANSOCO]2.0.CO;2.

