...
Before performing ancestral state reconstruction, the function **fastAnc()**, provided by the package **phytools**, was used to perform a fast estimate of the maximum likelihood ancestral states for our data set, the fourth trochanter positions. Optional variance and 95-percent confidence intervals on the obtained estimates were also conducted. The resulting 
